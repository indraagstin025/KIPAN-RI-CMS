...
import { PENDAFTARAN_FLOW } from '@/data/kipan-data';
            ...
            <div className="relative container mx-auto px-4 sm:px-6 lg:px-8">
                ...
                >
                    ...
                    <h2 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-blue-950 leading-tight">
                        5 Langkah Menjadi <span className="text-gradient-water">Pengurus KIPAN</span>
                    </h2>
                ...
                <div className="max-w-4xl mx-auto">
                    {PENDAFTARAN_FLOW.map((step, idx) => {
                        const Icon = ICON_MAP[step.icon] || FileText;
                        const isLast = idx === PENDAFTARAN_FLOW.length - 1;
                        return (
                            <motion.div
                                key={step.step}
